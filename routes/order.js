...
const { orderById, create, listOrders, getStatusValues, updateOrderStatus, getOrderStatus } = require('../controllers/order');
...
router.post('/order/by/status', getOrderStatus);
